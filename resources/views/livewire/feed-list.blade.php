<div class="space-y-4">
    ...
    <div class="space-y-3 cursor-pointer">
		...
		<div class="p-3 bg-white dark:bg-neutral-800 rounded-lg border border-gray-200 dark:border-neutral-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
